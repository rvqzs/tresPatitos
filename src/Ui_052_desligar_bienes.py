...
class Ui_Desligar(object):
    def setupUi(self, Desligar):
        ...
        self.tblDesligar2.setColumnCount(3)
        self.tblDesligar2.setObjectName("tblDesligar2")
        self.tblDesligar2.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tblDesligar2.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblDesligar2.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblDesligar2.setHorizontalHeaderItem(2, item)
        self.tblDesligar2.horizontalHeader().setCascadingSectionResizes(False)
        self.tblDesligar2.horizontalHeader().setSortIndicatorShown(False)
...
"")
        ...
        self.txtNombre.setGeometry(QtCore.QRect(140, 120, 121, 20))
...
"}")
    ...
    def retranslateUi(self, Desligar):
        ...
        item = self.tblDesligar2.horizontalHeaderItem(0)
        item.setText(_translate("Desligar", "Cedula"))
        item = self.tblDesligar2.horizontalHeaderItem(1)
        item.setText(_translate("Desligar", "Nombre"))
        item = self.tblDesligar2.horizontalHeaderItem(2)
        item.setText(_translate("Desligar", "Bien asignado"))
