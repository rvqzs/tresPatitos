...
class Ui_Empleados(object):
    def setupUi(self, Empleados):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Users\\aaron\\OneDrive\\Documentos\\Python\\tresPatitosUIA\\src\\../res/IconMenuEmpleados.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"background-color: rgba(0,0,0,0%);")
        ...
        self.label_headerIcon.setPixmap(QtGui.QPixmap("c:\\Users\\aaron\\OneDrive\\Documentos\\Python\\tresPatitosUIA\\src\\../res/iconEmpleadoHeader.png"))
...
"}")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("c:\\Users\\aaron\\OneDrive\\Documentos\\Python\\tresPatitosUIA\\src\\../res/btnCrear.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("c:\\Users\\aaron\\OneDrive\\Documentos\\Python\\tresPatitosUIA\\src\\../res/btnEdit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Empleados):
        ...
        self.bttLimpiarEmpleado.setToolTip(_translate("Empleados", "CTRL+R"))
        self.bttLimpiarEmpleado.setText(_translate("Empleados", "Limpiar"))
        self.bttLimpiarEmpleado.setShortcut(_translate("Empleados", "Ctrl+R"))
        self.bttEliminarEmpleado.setToolTip(_translate("Empleados", "CTRL+Del"))
        self.bttEliminarEmpleado.setText(_translate("Empleados", "Eliminar"))
        self.bttEliminarEmpleado.setShortcut(_translate("Empleados", "Ctrl+Del"))
        self.bttCrearEmpleado.setToolTip(_translate("Empleados", "CTRL+S"))
        self.bttCrearEmpleado.setText(_translate("Empleados", "Crear"))
        self.bttCrearEmpleado.setShortcut(_translate("Empleados", "Ctrl+S"))
        self.bttModificarEmpleado.setToolTip(_translate("Empleados", "CTRL+E"))
        self.bttModificarEmpleado.setText(_translate("Empleados", "Modificar"))
        self.bttModificarEmpleado.setShortcut(_translate("Empleados", "Ctrl+E"))
