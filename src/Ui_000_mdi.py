...
class Ui_mdiWindow(object):
    def setupUi(self, mdiWindow):
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("c:\\Users\\rviqu\\OneDrive - Universidad Internacional de las Américas (UIA)\\UIA\\2024\\I\\Programación II\\Proyecto Final\\tresPatitosUIA\\src\\../res/iconMenuReportes.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
