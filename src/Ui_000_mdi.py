...
class Ui_mdiWindow(object):
    def setupUi(self, mdiWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/mdiIcon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/buttons/iconMenu.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons8-goods-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/iconUsuarios.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/empleados.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/iconDepartamentos.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/buttons/iconLogout.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/buttons/iconRegistrar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/iconAsignar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mnuAsignar.setIcon(icon9)
        self.mnuAsignar.setObjectName("mnuAsignar")
        self.mnuDesligar = QtWidgets.QAction(mdiWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/buttons/iconDesligar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mnuDesligar.setIcon(icon10)
        self.mnuDesligar.setObjectName("mnuDesligar")
        self.mniReportes = QtWidgets.QAction(mdiWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icons/iconReportes.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
