...
class Ui_mdiWindow(object):
    def setupUi(self, mdiWindow):
        ...
        self.menuBienes.setGeometry(QtCore.QRect(468, 398, 175, 137))
        font = QtGui.QFont()
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("c:\\Users\\rviqu\\OneDrive - Universidad Internacional de las Américas (UIA)\\UIA\\2024\\I\\Programación II\\Proyecto Final\\tresPatitosUIA\\src\\../res/iconMenuUsers.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mniUsuarios.setIcon(icon3)
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setPointSize(12)
        font.setBold(True)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("c:\\Users\\rviqu\\OneDrive - Universidad Internacional de las Américas (UIA)\\UIA\\2024\\I\\Programación II\\Proyecto Final\\tresPatitosUIA\\src\\../res/IconMenuEmpleados.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mniEmpleados.setIcon(icon4)
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setPointSize(12)
        font.setBold(True)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("c:\\Users\\rviqu\\OneDrive - Universidad Internacional de las Américas (UIA)\\UIA\\2024\\I\\Programación II\\Proyecto Final\\tresPatitosUIA\\src\\../res/iconMenuDepartamentos.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mniDepartamentos.setIcon(icon5)
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setPointSize(12)
        font.setBold(True)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("c:\\Users\\rviqu\\OneDrive - Universidad Internacional de las Américas (UIA)\\UIA\\2024\\I\\Programación II\\Proyecto Final\\tresPatitosUIA\\src\\../res/iconLogout.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("c:\\Users\\rviqu\\OneDrive - Universidad Internacional de las Américas (UIA)\\UIA\\2024\\I\\Programación II\\Proyecto Final\\tresPatitosUIA\\src\\../res/iconMenuRegistrar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mniRegistrarBienes.setIcon(icon7)
        self.mniRegistrarBienes.setObjectName("mniRegistrarBienes")
        self.mnuAsignar = QtWidgets.QAction(mdiWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("c:\\Users\\rviqu\\OneDrive - Universidad Internacional de las Américas (UIA)\\UIA\\2024\\I\\Programación II\\Proyecto Final\\tresPatitosUIA\\src\\../res/iconAsignar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mnuAsignar.setIcon(icon8)
        self.mnuAsignar.setObjectName("mnuAsignar")
        self.mnuDesligar = QtWidgets.QAction(mdiWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("c:\\Users\\rviqu\\OneDrive - Universidad Internacional de las Américas (UIA)\\UIA\\2024\\I\\Programación II\\Proyecto Final\\tresPatitosUIA\\src\\../res/iconDesligar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mnuDesligar.setIcon(icon9)
        ...
        self.subMenuReporteEmpleados = QtWidgets.QAction(mdiWindow)
        self.subMenuReporteEmpleados.setObjectName("subMenuReporteEmpleados")
        self.subMnuGraficoEstado = QtWidgets.QAction(mdiWindow)
        self.subMnuGraficoEstado.setObjectName("subMnuGraficoEstado")
        self.subMenuITSupport = QtWidgets.QAction(mdiWindow)
        self.subMenuITSupport.setObjectName("subMenuITSupport")
        ...
        self.menuReportes.addAction(self.subMenuReporteEmpleados)
        self.menuReportes.addAction(self.subMnuGraficoEstado)
        ...
        self.menuMain.addSeparator()
        self.menuHelp.addAction(self.subMenuITSupport)
    ...
    def retranslateUi(self, mdiWindow):
        ...
        self.menuHelp.setTitle(_translate("mdiWindow", "Help"))
        ...
        self.subMenuReporteEmpleados.setText(_translate("mdiWindow", "Empleados por Departamento"))
        self.subMnuGraficoEstado.setText(_translate("mdiWindow", "Gráfico Estado de Bienes"))
        self.subMenuITSupport.setText(_translate("mdiWindow", "IT Support"))
