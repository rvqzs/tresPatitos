...
class Ui_mdiWindow(object):
    def setupUi(self, mdiWindow):
        ...
        self.menuBienes.setGeometry(QtCore.QRect(451, 219, 175, 137))
        font = QtGui.QFont()
        ...
        self.menuBienes.setContextMenuPolicy(QtCore.Qt.ActionsContextMenu)
        self.menuBienes.setStyleSheet("font: 63 12pt \"Segoe UI Semibold\";")
        self.menuBienes.setTearOffEnabled(False)
        icon2 = QtGui.QIcon()
        ...
        font.setBold(True)
        font.setWeight(75)
        self.menuReportes.setFont(font)
        ...
        self.mniUsuarios.setEnabled(True)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("c:\\Users\\aaron\\OneDrive\\Documentos\\Python\\tresPatitosUIA\\src\\../res/iconMenuUsers.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.mniUsuarios.setVisible(True)
        self.mniUsuarios.setObjectName("mniUsuarios")
        self.mniEmpleados = QtWidgets.QAction(mdiWindow)
        self.mniEmpleados.setCheckable(False)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("c:\\Users\\aaron\\OneDrive\\Documentos\\Python\\tresPatitosUIA\\src\\../res/IconMenuEmpleados.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("c:\\Users\\aaron\\OneDrive\\Documentos\\Python\\tresPatitosUIA\\src\\../res/iconMenuDepartamentos.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("c:\\Users\\aaron\\OneDrive\\Documentos\\Python\\tresPatitosUIA\\src\\../res/iconLogout.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("c:\\Users\\aaron\\OneDrive\\Documentos\\Python\\tresPatitosUIA\\src\\../res/iconMenuRegistrar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("c:\\Users\\aaron\\OneDrive\\Documentos\\Python\\tresPatitosUIA\\src\\../res/iconAsignar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mnuAsignar.setIcon(icon8)
        self.mnuAsignar.setObjectName("mnuAsignar")
        self.mnuDesligar = QtWidgets.QAction(mdiWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("c:\\Users\\aaron\\OneDrive\\Documentos\\Python\\tresPatitosUIA\\src\\../res/iconDesligar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        font.setBold(True)
        font.setWeight(75)
        self.subMenuITSupport.setFont(font)
